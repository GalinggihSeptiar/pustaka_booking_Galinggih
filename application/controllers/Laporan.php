...
class Laporan extends CI_Controller
{
    ...
    public function laporan_anggota()
    {
        ...
        $data['user'] = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])->row_array();
        $data['anggota'] =$this->ModelUser->getUserWhere()->result_array();
    ...
    {
        $data['anggota'] =$this->ModelUser->getUserWhere()->result_array();
        $this->load->view('anggota/laporan-print-anggota', $data);
        }
    ...
    {
        {
            ...
            // nama file pdf yang di hasilkan
            $this->pdf->load_view('anggota/laporan-pdf-anggota', $data);
        }
    }
    
    public function export_excel_anggota()
    {
        $data = array( 'title' => 'Laporan Data Anggota', 'anggota' => $this->ModelUser->getUserWhere()->result_array());
        $this->load->view('anggota/export-excel-anggota', $data);
        }
